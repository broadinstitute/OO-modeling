...
# closest estimate
closest <- which(abs(deg2 - mod_vals) == min(abs(deg2 - mod_vals)[abs(deg2 - mod_vals) > 0]))
...
ggplot(dat3, aes(x=x,y=y)) +
  ...
  theme_minimal() +
  labs(
    title = "Time-Weighted First- and Second-Degree Contacts, BYU",
...
# equal weight
summary(lm(final_BYU ~ deg[deg!=0] + 0))

# duration weight
summary(lm(final_BYU ~ colsums(real_adj)[colsums(real_adj) > 0] + 0))

# kickass one
summary(lm(final_BYU ~ colsums(real_adj)[colsums(real_adj) > 0] + colsums(mat2)[colsums(real_adj) > 0] + 0))

# correlated residuals

cor.test(residuals(lm(colsums(mat2) ~ colsums(real_adj)+ 0))[colsums(real_adj) > 0], final_BYU)
...
Scene 7a: Histogram of cumulative cases after 4-weeks (incl. index) - different R0
```{r}
...
for (R0 in seq(1,3,0.5)) {
  lambda <- nlm(err, R0/(((sigma2 + mu^2)/mu - 1) * mean(total_time)))$estimate
  new_results <- matrix(unlist(mclapply(1:1000, outbreak, mc.cores = 12)), ncol = 2, byrow = TRUE)
...
for (i in seq(1,3,0.5)) {
  print(mean(results_R0$cases[which(results_R0$R0 == i)]))
  print(median(results_R0$cases[which(results_R0$R0 == i)]))
  print(quantile(results_R0$cases[which(results_R0$R0 == i)], c(0.025, 0.975), type = 1))
}
...
Scene 7b: Histogram of cumulative cases after 4-weeks (incl. index) - different testing
```{r}
...
for (daily_tests in seq(500,2000,500)) {
  ...
  new_results <- as.data.frame(matrix(unlist(mclapply(1:1000, outbreak, daily_tests = daily_tests, mc.cores = 12)), ncol = 2, byrow = TRUE))
...
for (daily_tests in seq(500,2000,500)) {
  ...
  new_results <- as.data.frame(matrix(unlist(mclapply(1:1000, outbreak, daily_tests = daily_tests, test_strategic = TRUE, mc.cores = 12)), ncol = 2, byrow = TRUE))
  new_results <- cbind(new_results, rep(daily_tests, nrow(new_results)))
...
for (i in seq(500,2000,500)) {
  print(mean(results_testing$primary_transmissions[which(results_testing$daily_tests == i & results_testing$type == "random")]))
  print(mean(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "random")]))
  print(median(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "random")]))
  print(quantile(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "random")], c(0.025, 0.975), type = 1))
}

for (i in seq(500,2000,500)) {
  print(mean(results_testing$primary_transmissions[which(results_testing$daily_tests == i & results_testing$type == "strategic")]))
  print(mean(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "strategic")]))
  print(median(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "strategic")]))
  print(quantile(results_testing$cases[which(results_testing$daily_tests == i & results_testing$type == "strategic")], c(0.025, 0.975), type = 1))
}
...
Scene 7c: Histogram of cumulative cases after 4-weeks (incl. index) - different vax
```{r}
...
for (p_vax in seq(0.2,0.8,0.2)) {
  ...
  new_results <- as.data.frame(matrix(unlist(mclapply(1:1000, outbreak, p_vax = p_vax, mc.cores = 12)), ncol = 2, byrow = TRUE))
...
for (p_vax in seq(0.2,0.8,0.2)) {
  ...
  new_results <- as.data.frame(matrix(unlist(mclapply(1:1000, outbreak, p_vax = p_vax, vax_strategic = TRUE, mc.cores = 12)), ncol = 2, byrow = TRUE))
  new_results <- cbind(new_results, rep(p_vax, nrow(new_results)))
  new_results <- cbind(new_results, rep("strategic", nrow(new_results)))
  colnames(new_results) <- c("primary_transmissions", "cases", "p_vax", "type")
  results_vax <- rbind(results_vax, as.data.frame(new_results))
...
for (i in seq(0.2,0.8,0.2)) {
  print(mean(results_vax$primary_transmissions[which(results_vax$p_vax == i & results_vax$type == "random")]))
  print(mean(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "random")]))
  print(median(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "random")]))
  print(quantile(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "random")], c(0.025, 0.975), type = 1))
}

for (i in seq(0.2,0.8,0.2)) {
  print(mean(results_vax$primary_transmissions[which(results_vax$p_vax == i & results_vax$type == "strategic")]))
  print(mean(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "strategic")]))
  print(median(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "strategic")]))
  print(quantile(results_vax$cases[which(results_vax$p_vax == i & results_vax$type == "strategic")], c(0.025, 0.975), type = 1))
}
...
write.csv(promiscuity, "promiscuity_BYU.csv")
